    ...
    <div className="space-y-8">
      ...
      <div className="max-w-2xl mx-auto">
        <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-md p-8 space-y-6">
          ...
          {/* Jumlah */}
          <div>
            <label htmlFor="amount" className="block text-sm font-bold text-slate-900 mb-2">
              Jumlah (Rp)
            </label>
            <input
              id="amount"
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-primary-600 to-primary-700 text-white font-bold py-3 px-4 rounded-lg hover:shadow-lg transition-all flex items-center justify-center gap-2"
          >
            <Send size={20} />
            Simpan Transaksi
          </button>
